...
import (
	...
	informers "k8s_customize_controller/pkg/client/informers/externalversions/stable/v1"
	listers "k8s_customize_controller/pkg/client/listers/stable/v1"
)
