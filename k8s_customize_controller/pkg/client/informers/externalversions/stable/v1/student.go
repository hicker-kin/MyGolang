...
import (
	...
	v1 "k8s_customize_controller/pkg/client/listers/stable/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.StableV1().Students(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StableV1().Students(namespace).Watch(context.TODO(), options)
			},
		},
		&stablev1.Student{},
		resyncPeriod,
